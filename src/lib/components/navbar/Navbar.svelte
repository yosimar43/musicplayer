...
<div
  class="fixed top-0 left-0 right-0 z-50 flex justify-center pt-6 pointer-events-none"
>
  <nav
    ...
    class="w-[85%] backdrop-blur-xl bg-white/10 border border-sky-400/30
           ...
           {uiStore.navbarHidden
      ? 'scale-[0.92] opacity-55 -translate-y-8'
  ...
  >
    <div class="flex items-center justify-between px-6 py-4">
      ...
      <div class="flex items-center gap-4">
        <div
          class="w-12 h-12 rounded-2xl bg-gradient-to-br from-cyan-400 to-sky-500
        ...
        <h1
          class="text-2xl font-bold text-white/95 transition-opacity duration-500
